...
DEFAULT_ASSOCIATION_POLICY = {
    ...
    "decision_policy": {
        ...
        "topology_supported_accept": {
            ...
            "min_time_score": 0.9,
                    "min_topology_score": 0.85,
            "max_primary_shortfall": 0.1,
            "require_exact_zone": True,
            "require_exact_subzone": True,
            "require_unique_candidate": True,
            "max_candidate_count_after_filter": 1,
            "dynamic_body_threshold_enabled": False,
            "dynamic_body_threshold_ratio": 0.8,
            "dynamic_body_threshold_max_relaxation": 0.16,
            "min_dynamic_body_score": 0.55,
            "strong_face_conflict_max_score": 0.2,
        },
    },
}
